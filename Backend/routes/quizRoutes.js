...
import { authenticate, authorize, authorizeEnrolledStudentForLesson } from '../middleware/auth.js';
import {
...
router.post('/lesson/:lesson_id/submit', authorizeEnrolledStudentForLesson, [
